...
from extract_embs_last_layer.f0_predictor.rmvpe import RMVPE
from extract_embs_last_layer.f0_predictor.F0Predictor import F0Predictor
...
class RMVPEF0Predictor(F0Predictor):
    def __init__(
        ...
        ckpt_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../ssl_checkpoints/RMVPE/rmvpe.pt")
