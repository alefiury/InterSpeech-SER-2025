...
LAST_LAYER_OUTPUT_DIR = "Texts_RobertaLarge_last_layer"
MODEL_NAME = "FacebookAI/roberta-large"  # Pre-trained model name or path
...
def process_row(row: pd.Series, output_dir: str, model, tokenizer, device: torch.device):
    ...
    try:
        ...
        # if os.path.exists(last_layer_output_filepath):
...
def main():
    ...
    if torch.cuda.is_available():
        ...
        max_workers = 12  # Adjust based on your GPU's capability
