...
def main() -> None:
    ...
    # output_dir = "results_true_test"
    output_dir = "results_unlabeled"
    os.makedirs(output_dir, exist_ok=True)
    # filename = f"results_true_test-{args.checkpoint_path.split('/')[-4]}-{os.path.basename(args.test_metadata_path)[:-4]}"
    filename = f"results_{args.checkpoint_path.split('/')[-4]}-{os.path.basename(args.test_metadata_path)[:-4]}"
